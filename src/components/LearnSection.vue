<template>
    <div class="card-contenitore d-flex justify-content-around my-5 py-3 background-container">
        ...
        <div class="img-container-background position-relative">
             ...
             <img class="decoration" src="../assets/maxcoach-shape-05.png" alt="">
        </div>
    </div>
</template>
    ...
    data:function () {
        return{
            benefits:[
                ...
                {
                    text:'Change the tutor and make arrangements'
                },
                {
                    text:'Participate in events to join others'
                },
                {
                    text:'Get the disired certificaate delivdred at house'
                }
            ]
        }
    }
